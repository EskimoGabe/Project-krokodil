<h1 align="center">крокодил.io</h1>
(ENG)
крокодил.io is an alternative to the web-based drawing game крокодил.io. My main
problems with крокодил.io were the ads and the fact that a disconnect would
cause you to lose your points. On top of that, the automatic word choice was
quite annoying and caused some frustration.

(RUS)
крокодил.io — это альтернатива онлайн-игре для рисования крокодил.io. Мой основной
проблемы со крокодил.io заключались в рекламе и в том, что дисконнект
привести к потере очков. Кроме того, был автоматический выбор слов.
довольно раздражает и вызывает некоторое разочарование.
